...
import 'package:flutter_study/game/widget/cpu_input.dart';
import 'package:flutter_study/game/widget/game_result.dart';
import 'package:flutter_study/game/widget/user_input.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Expanded(
          child:
              GameResult(isDone: isDone, result: getResult(), callback: reset),
        ),
        Expanded(
          child: UserInput(
